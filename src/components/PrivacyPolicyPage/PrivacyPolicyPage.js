...
export default function PrivacyPolicyPage() {
    ...
    return (
        <div className="privacy-policy-container">
            ...
            <p>
                Согласие субъекта персональных данных: Пользователь сам вводит
                данные и отправляет форму, выражая согласие на их обработку для
                цели ответа (напрямую следует из ст. 24 Конституции).
            </p>
            <p>
            ...
            <p>
                ...
                <a href={`mailto:${operatorEmail}`}>{operatorEmail}</a> с
